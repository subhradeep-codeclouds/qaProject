...
export default function Header({ title }: { title: string }) {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 sticky top-0 z-30
      bg-white/90 backdrop-blur-xl border-b border-violet-100 shadow-sm shadow-violet-100/40
        ...
        <div className="relative hidden sm:flex items-center">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 text-xs rounded-xl w-52 transition-all
              bg-violet-50 border border-violet-100 text-slate-600 placeholder:text-slate-400
        ...
        <button
          ...
          className={`relative flex items-center w-[52px] h-7 rounded-full transition-all duration-300 ${
            dark
              ...
              : 'bg-gradient-to-r from-violet-500 to-indigo-400 shadow-md shadow-violet-200'
          }`}>
          <div className={`absolute w-5 h-5 rounded-full bg-white shadow-md transition-all duration-300
            ...
            {dark
              ...
              : <Sun  size={10} className="text-violet-500" />
            }
          </div>
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="w-9 h-9 rounded-xl flex items-center justify-center
              ...
              hover:shadow-violet-300 dark:hover:shadow-violet-800/40 transition-shadow">
          ...
          {showMenu && (
            <>
              ...
              <div className="absolute right-0 top-11 z-20 w-44 rounded-2xl border shadow-xl p-1.5
                bg-white border-violet-100 shadow-violet-100
                dark:bg-[#0c2040] dark:border-[#1a3355] dark:shadow-[#071b3c]">
                <div className="px-3 py-2 border-b mb-1 border-violet-50 dark:border-[#1a3355]">
